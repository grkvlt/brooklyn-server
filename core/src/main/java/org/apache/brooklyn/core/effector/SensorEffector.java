 ...
 *   - type: org.apache.brooklyn.core.effector.SensorEffector
 *     brooklyn.config:
 *       name: setStatus
 ...
 */
@Beta
public class SensorEffector extends AddEffector {

    private static final Logger LOG = LoggerFactory.getLogger(SensorEffector.class);
    ...
    public SensorEffector(Map<?, ?> params) {
        this(ConfigBag.newInstance(params));
    }

    public SensorEffector(ConfigBag params) {
        this(newEffectorBuilder(params).build());
    }

    public SensorEffector(Effector<?> effector) {
        super(effector);
    }
